...
export function GameScene({ 
  ...
  return (
    ...
    >
      ...
      {/* Table with props */}
      <div className="absolute bottom-[15%] left-1/2 -translate-x-1/2 w-[25%] h-[20%]">
      ...
      <div className="absolute bottom-[3%] left-[20%] w-[18%] h-[25%] rotate-[-90deg]">
        <img src={losCabosImage} alt="Los Cabos" className="w-full h-full object-contain opacity-80" />
      </div>
      
      {/* Blood pool effect */}
      <div className="absolute bottom-[5%] left-[22%] w-[12%] h-[8%] bg-red-900/60 rounded-full blur-sm" />

      {/* Dagger near the body */}
      {!gameState.flags.daggerTaken && (
        <div className="absolute bottom-[8%] left-[32%] w-[6%] h-[8%]">
          <img src={daggerImage} alt="Bloody Dagger" className="w-full h-full object-contain rotate-45" />
        </div>
      )}

      {/* Surviving characters - standing on the right side */}
      <div className="absolute bottom-[3%] right-[25%] w-[12%] h-[35%]">
        <img src={carlImage} alt="Carl" className="w-full h-full object-contain" />
      </div>
      
      <div className="absolute bottom-[3%] right-[12%] w-[12%] h-[35%]">
        <img src={ladyImage} alt="Lady" className="w-full h-full object-contain" />
      </div>
      
      <div className="absolute bottom-[3%] right-[0%] w-[12%] h-[35%]">
